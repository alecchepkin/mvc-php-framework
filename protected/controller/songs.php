...
class Songs extends Controller {
    ...
    public function index() {
        ...
        require App::get()->basePath . '/protected/views/_templates/header.php';
        require App::get()->basePath . '/protected/views/songs/index.php';
        require App::get()->basePath . '/protected/views/_templates/footer.php';
    }
